...
MODEL_METADATA = {
    ...
    'almanach/camembertav2-base': {
        ...
        'size': 'Base',
        'multilingual': False,
        'description': 'CamemBERTav2 Base: Current French SOTA (Nov 2024) from ALMAnaCH/Inria. Trained with DeBERTaV3 objective on updated French corpora. ~110M parameters. Surpasses all previous French models on standard benchmarks. Use for: any French NLP task requiring best accuracy. Recommended default for French.'
    },
    'moussaKam/barthez': {
