...
class AnnotationStudioSessionManager:
    ...
    STEPS: List[SessionStep] = [
        ...
        SessionStep("doccano_validation", "Doccano validation sample", "Annotate sample & push to Doccano", 9),
        SessionStep("export_options", "Export options", "Define outputs and formats", 10),
        SessionStep("review_launch", "Review & launch", "Final confirmation and execution", 11),
    ]
