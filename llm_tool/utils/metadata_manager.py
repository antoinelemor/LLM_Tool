...
class MetadataManager:
    ...
    def _extract_dataset_config(self, bundle) -> Dict[str, Any]:
        ...
        if hasattr(bundle, 'metadata') and bundle.metadata:
            ...
            config["multilabel_keys"] = bundle.metadata.get('multilabel_keys', [])
    ...
    def _extract_advanced_settings(
        ...
        if hasattr(bundle, 'metadata') and bundle.metadata:
            ...
            if bundle.metadata.get('training_approach') == 'multi-label' or bundle.metadata.get('multi_label', False):
