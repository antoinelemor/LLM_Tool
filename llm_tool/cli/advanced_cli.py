...
class AdvancedCLI:
        ...
        try:
            ...
            if df is not None and text_column and text_column in df.columns:
                ...
                try:
                    ...
                    if display_results and self.console:
                        # Statistics table
                        stats_table = Table(title="Text Length Statistics", border_style="cyan", show_header=True, header_style="bold", expand=True)
                        ...
                        # Distribution table
                        self.console.print("\n")
                        dist_table = Table(title="Document Length Distribution", border_style="cyan", show_header=True, header_style="bold", expand=True)
                        dist_table.add_column("Category", style="cyan", no_wrap=True)
                        dist_table.add_column("Token Range", style="white", no_wrap=True)
                        dist_table.add_column("Count", style="yellow", justify="right", no_wrap=True)
                        dist_table.add_column("Percentage", style="green", justify="right", no_wrap=True)
    ...
    def _display_detection_results(self):
        ...
        llms_table.add_column("Context", style="green", no_wrap=True)
        llms_table.add_column("Status", style="green", no_wrap=True)
        ...
        datasets_table.add_column("Origin", style="yellow", no_wrap=True, justify="center")
        datasets_table.add_column("Columns", style="dim", ratio=1)
    ...
    def get_main_menu_choice(self) -> str:
        ...
        if HAS_RICH and self.console:
            ...
            print("Main Menu")
            print("="*50)
            print("1. The Annotator - Zero-Shot LLM Annotation (OpenAI/Ollama) → Export")
    ...
    def quick_start_wizard(self):
        ...
        if HAS_RICH and self.console:
            ...
            workflow_table.add_column("Option", style="cyan", no_wrap=True)
    ...
    def _resume_mode2(self, focus_session_id: Optional[str] = None):
        ...
        sessions_table = Table(border_style="cyan", show_header=True, expand=True)
        ...
        sessions_table.add_column("Status", style="green", no_wrap=True)
    ...
    def _execute_mode2_from_metadata(self, metadata: dict, action_mode: str, metadata_file: Path):
        ...
        if action_mode == 'resume':
            ...
            stage_table = Table(title="Resume Stage Selection", border_style="cyan", expand=True)
    ...
    def _post_annotation_training_workflow(
        ...
        try:
            ...
            from rich.table import Table
            cat_table = Table(title="Category Distribution", border_style="cyan", show_header=True, header_style="bold", expand=True)
            cat_table.add_column("Category", style="cyan", no_wrap=True)
            cat_table.add_column("Count", style="yellow", justify="right", no_wrap=True)
            cat_table.add_column("Percentage", style="green", justify="right", no_wrap=True)
    ...
    def _select_llm_interactive(self) -> ModelInfo:
        ...
        while True:
            ...
            if openai_llms:
                ...
                openai_table.add_column("Model Name", style="white", no_wrap=True)
                openai_table.add_column("In\n($/1M)", style="magenta", justify="right", no_wrap=True)
                openai_table.add_column("Out\n($/1M)", style="magenta", justify="right", no_wrap=True)
                openai_table.add_column("Cache\n($/1M)", style="magenta", justify="right", no_wrap=True)
                openai_table.add_column("Batch In\n($/1M)", style="cyan", justify="right", no_wrap=True)
                openai_table.add_column("Batch Cache\n($/1M)", style="cyan", justify="right", no_wrap=True)
                openai_table.add_column("Batch Out\n($/1M)", style="cyan", justify="right", no_wrap=True)
                openai_table.add_column("Description", style="dim", overflow="fold", ratio=1)
            ...
            if HAS_RICH and self.console:
                ...
                if self.detected_datasets:
                    ...
                    if datasets:
                        ...
                        datasets_table.add_column("Format", style="yellow bold", no_wrap=True, justify="center")
                        datasets_table.add_column("Size", style="green", no_wrap=True, justify="right")
                        datasets_table.add_column("Origin", style="yellow", no_wrap=True, justify="center")
                        datasets_table.add_column("Path", style="dim", ratio=1, no_wrap=True)
...
Format your response as JSON with keys: topic, sentiment, entities, summary"""
        ...
        try:
            ...
            if use_llm_assist:
                ...
                if not available_models:
                    ...
                    table.add_column("Model", style="white bold", no_wrap=True)
                    table.add_column("Provider", style="yellow", no_wrap=True)
                    table.add_column("Type / Size", style="green", no_wrap=True)
    ...
    def _display_training_modes_explanation(self):
        ...
        if HAS_RICH and self.console:
            ...
            table = Table(title="Mode Comparison", border_style="blue", show_header=True, expand=True)
            table.add_column("Mode", style="bold cyan", no_wrap=True)
            table.add_column("Epochs", justify="center", style="yellow", no_wrap=True)
            table.add_column("Batch", justify="center", style="yellow", no_wrap=True)
            table.add_column("L.Rate", justify="center", style="yellow", no_wrap=True)
            table.add_column("Models", justify="center", style="yellow", no_wrap=True)
            table.add_column("Use Case", style="green", ratio=1, overflow="fold")
    ...
    def _display_metadata_parameters(self, metadata: dict):
        ...
        params_table.add_column("Section", style="yellow bold", no_wrap=True)
        ...
        # Processing
        proc_config = metadata.get('processing_configuration', {})
        params_table.add_row("Processing", f"Workers: {proc_config.get('parallel_workers', 1)}")
    ...
    def _clean_metadata(self):
        ...
        if clean_choice == "1":
            ...
            files_table = Table(border_style="cyan", show_header=True, expand=True)
            files_table.add_column("#", style="cyan", width=4)
            files_table.add_column("Filename", style="white", no_wrap=True)
            files_table.add_column("Date", style="yellow", no_wrap=True)
            files_table.add_column("Size", style="green", no_wrap=True)
    ...
    def _database_annotator(self):
        ...
        db_table = Table(title="Database Types", box=box.ROUNDED, expand=True)
        db_table.add_column("#", style="cyan", justify="right", width=4)
        db_table.add_column("Database Type", style="green", no_wrap=True)
        ...
        try:
            ...
            col_table = Table(title=f"Columns in '{selected_table}'", box=box.ROUNDED, expand=True)
            col_table.add_column("#", style="cyan", justify="right", width=4)
            col_table.add_column("Column Name", style="green", no_wrap=True)
            col_table.add_column("Type", style="yellow", no_wrap=True)
            col_table.add_column("Detection", style="magenta", ratio=1)
        ...
        from llm_tool.utils.sampling import cochran_sample_size as calculate_representative_sample
        ...
        sampling_table = Table(title="Sampling Strategy Options", box=box.ROUNDED, expand=True)
        sampling_table.add_column("#", style="cyan", justify="right", width=4)
        sampling_table.add_column("Strategy", style="green", ratio=1)
        ...
        if num_rows < total_rows:
            ...
            method_table = Table(title="Sampling Method", box=box.ROUNDED, expand=True)
            method_table.add_column("#", style="cyan", justify="right", width=4)
            method_table.add_column("Method", style="green", ratio=1)
        ...
        output_table = Table(title="Output Destination Options", box=box.ROUNDED, expand=True)
        output_table.add_column("#", style="cyan", justify="right", width=4)
        output_table.add_column("Destination", style="green", ratio=1)
