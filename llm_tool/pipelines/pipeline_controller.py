...
class PipelineController:
    ...
    def _prepare_annotation_config(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        optional_fields = {
            ...
            'skip_annotation_pairs': config.get('skip_annotation_pairs'),
            'skip_annotation_text_column': config.get('skip_annotation_text_column'),
            'save_incrementally': config.get('save_incrementally', True),
            'openai_batch_dir': config.get('openai_batch_dir'),
            'openai_batch_archive_dir': config.get('openai_batch_archive_dir'),
