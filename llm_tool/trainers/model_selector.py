...
from llm_tool.utils.training_paths import get_training_logs_base, resolve_metrics_base_dir
...
class ModelSelector:
    ...
    MODEL_PROFILES = {
        ...
        'CamemBERTav2Base': ModelProfile(
            ...
            accuracy_score=0.93,
            complexity_handling='complex',
            special_features=['CamemBERTav2', 'French SOTA Nov 2024', 'DeBERTa-v3 training', 'ALMAnaCH/Inria'],
            recommended_tasks=['French NLP', 'French text classification', 'French NER', 'French sentiment analysis'],
            supported_languages=['fr']  # French SOTA model
        ),
    ...
    def benchmark_models(self,
        ...
        for model_name in models_to_test:
            ...
            try:
                ...
                metrics_base_dir = str(resolve_metrics_base_dir(None))
                scores = model.run_training(
                    ...
                    # GPU Optimization - use defaults for model selection (quick benchmarks)
                    fp16=False,
