...
class CamemBERTav2Base(BertBase):
    """CamemBERTav2 Base: Current French SOTA (Nov 2024) from ALMAnaCH/Inria.
    Trained with DeBERTaV3 objective on updated French corpora.
    Surpasses all previous French models on standard benchmarks."""
